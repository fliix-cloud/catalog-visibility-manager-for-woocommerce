				...
				<div class="fliix-hcp" id="fliix-hcp-tree-root" data-fliix-hcp-tree>
					<div class="fliix-hcp__toolbar">
						<label class="screen-reader-text" for="fliix-hcp-search">
							<?php esc_html_e( 'Search categories', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
						</label>
						<input
							type="search"
							id="fliix-hcp-search"
							class="fliix-hcp__search regular-text"
							placeholder="<?php esc_attr_e( 'Search categories…', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>"
							autocomplete="off"
						/>
						<div class="fliix-hcp__toolbar-actions">
							<label class="fliix-hcp__filter-hidden">
								...
								<?php esc_html_e( 'Show only hidden', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
							</label>
						</div>
					</div>
					...
					<div class="fliix-hcp__body">
						<div class="fliix-hcp__header" aria-hidden="true">
							<span class="fliix-hcp__col fliix-hcp__col--name">
								<?php esc_html_e( 'Category', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
							</span>
							<span class="fliix-hcp__col fliix-hcp__col--toggle" title="<?php esc_attr_e( 'Hide this category from the store', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>">
								<?php esc_html_e( 'Hide category', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
							</span>
							<span class="fliix-hcp__col fliix-hcp__col--toggle" title="<?php esc_attr_e( 'Hide products in this category from the store', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>">
								<?php esc_html_e( 'Hide products', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
							</span>
						</div>

						<?php if ( [] === $this->terms_by_id ) : ?>
							<p class="fliix-hcp__empty">
								<?php esc_html_e( 'No product categories found.', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
							</p>
						<?php else : ?>
						...
						<p class="fliix-hcp__empty fliix-hcp__no-results" hidden>
							<?php esc_html_e( 'No categories match your search.', 'fliix-catalog-visibility-manager-for-woocommerce' ); ?>
						</p>
					</div>
				</div>
			</td>
			...
			<div class="fliix-hcp__row">
				...
				<label class="fliix-hcp__col fliix-hcp__col--toggle">
					<span class="screen-reader-text">
						...
						printf(
							...
							esc_html__( 'Hide category: %s', 'fliix-catalog-visibility-manager-for-woocommerce' ),
							esc_html( $term->name )
						);
						?>
					</span>
				...
				<label class="fliix-hcp__col fliix-hcp__col--toggle">
					<span class="screen-reader-text">
						...
						printf(
							/* translators: %s: category name */
							esc_html__( 'Hide products in: %s', 'fliix-catalog-visibility-manager-for-woocommerce' ),
							esc_html( $term->name )
						);
						?>
					</span>
