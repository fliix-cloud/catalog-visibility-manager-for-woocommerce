			...
			printf(
				...
				esc_html(
					sprintf(
						...
						__( 'Catalog Visibility Manager for WooCommerce requires PHP %1$s or higher. You are running PHP %2$s.', 'fliix-catalog-visibility-manager-for-woocommerce' ),
						'8.1',
						PHP_VERSION
					)
				)
...
define( 'FLIIX_HCP_VERSION', '2.2.3' );
